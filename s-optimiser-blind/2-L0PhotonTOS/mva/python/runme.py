...
sigfile = TFile('../mc-blind-creator/MC-blind.root')
# upper mass sideband as background proxy
bkgfile = TFile('../data-blind-creator/data-blind-sideband.root')
...
with TreeMaker("blind_data_withBDT.root", "DecayTree", ['B_M', 'Kst_M', 'gamma0_P', 'gamma1_P', 'diphoton_M', 'B_FD_OWNPV', 'B_P', 'B_PT', 'B_DIRA_OWNPV', 'B_ENDVERTEX_CHI2',
    ...
    tree = TreeWrapper(
        "../data-blind-creator/data-blind-full.root", "DecayTree")

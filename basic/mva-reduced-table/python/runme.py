...
for ii in range(ss, ss + (tt-1)*uu, uu):
    ...
    #eff = bdtmethod.GetEfficiency('', 0, effSerr)
# array.append(^^^) for eff and traineff

    print('the efficiencies are '+eff)

...
with TreeMaker("reduced_data_withBDT.root", "DecayTree", ['B_M', 'Kst_M', 'gamma0_P', 'gamma1_P', 'B_FD_OWNPV', 'B_P', 'B_PT', 'B_DIRA_OWNPV', 'B_ENDVERTEX_CHI2',
    ...
    tree = TreeWrapper(
        "../data-reduced-creator/data-reduced-full.root", "DecayTree")
...
canvas = TCanvas()
tree = TreeWrapper("reduced_data_withBDT.root", "DecayTree")

...
for ii in range(ss, ss + tt*uu, uu):
    ...
    bdtmethod = factory.BookMethod(dataloader, TMVA.Types.kBDT, 'BDT',
                                   'H:V:NTrees=800:MinNodeSize=0.5%:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta='+str(ii/20)+':UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=200')

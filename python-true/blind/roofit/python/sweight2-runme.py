...
mean = RooRealVar('mean',  'm_{B}',  5290)
sigma = RooRealVar('sigma', '#sigma',   93.13)
alpha = RooRealVar('alpha', '#alpha',   -1.391)
n = RooRealVar('n', '#n',   2.370)
...
Nsignal = RooRealVar('Nsignal', 'N_{Sig}', 2000, 0, 10000)
Nbackground = RooRealVar('Nbackground', 'N_{Bkg}', 5000, 0, 50000)

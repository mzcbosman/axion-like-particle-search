...
mc_treewrapper_up = TreeWrapper(
    '/vols/lhcb/mmccann/analysis/kstgg/tuples/MC/MC2018Kstgg_MagUp.root', 'DecayTree')

treemaker = TreeMaker(
    'MC-Kstgg.root',  # output file name
...
canvas3 = TCanvas()
that_tree = TreeWrapper('MC-Kstgg.root', 'DecayTree')

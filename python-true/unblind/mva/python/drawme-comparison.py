...
tree1 = TreeWrapper('unblind_data_sweighted.root', 'DecayTree')
tree2 = TreeWrapper('unblind_MC_withBDT.root', 'DecayTree')
...
hist_1 = TH1D('hist_1', 'sWeighted data', 100, begin, end)

...
sigfile = TFile('../../blind/mc-creator/MC-blind.root')
# upper mass sideband as background proxy
bkgfile = TFile('../../blind/data-creator/data-blind-sideband.root')
...
bdtmethod = factory.BookMethod(dataloader, TMVA.Types.kBDT, 'BDT',
                               "!H:!V:NTrees=800:MinNodeSize=1%:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.6:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=200")
...
with TreeMaker("unblind_data_withBDT.root", "DecayTree", ['B_M', 'Kst_M', 'gamma0_P', 'gamma1_P', 'diphoton_M', 'diphoton_with_constraint_M', 'B_FD_OWNPV', 'B_P', 'B_PT', 'B_DIRA_OWNPV', 'B_ENDVERTEX_CHI2',
    ...
    tree = TreeWrapper(
        "../data-creator/data-unblind-full.root", "DecayTree")
...
with TreeMaker("unblind_data_afterBDT.root", "DecayTree", ['B_M', 'Kst_M', 'gamma0_P', 'gamma1_P', 'diphoton_M', 'diphoton_with_constraint_M', 'B_FD_OWNPV', 'B_P', 'B_PT', 'B_DIRA_OWNPV', 'B_ENDVERTEX_CHI2',
                                                           'B_CONEP_100', 'B_CONEMULT_100', 'B_NC_IT_100', 'B_NEWVTXISODCHI2MASS', 'B_VTXISODCHI2MASSONETRACK',
                                                           'B_VTXISODCHI2MASSTWOTRACK', 'Kst_P', 'Kst_PT', 'K_P', 'K_PT', 'pi_P', 'pi_PT', 'Kst_IPCHI2_OWNPV',
                                                           'K_IPCHI2_OWNPV', 'pi_IPCHI2_OWNPV', 'K_ProbNNk', 'pi_ProbNNpi']) as outtree:
    tree = TreeWrapper(
        "unblind_data_withBDT.root", "DecayTree")
    for entry in tree.entry():
        if tree.BDT > 0 and 5000 <= tree.B_M < 6500:
            outtree.Fill({
                "B_M": tree.B_M,
                "Kst_M": tree.Kst_M,
                "gamma0_P": tree.gamma0_P,
